...
<!-- Tiger Cage/property-modern-view.html by g4bbar, Thu, 24 Jan 2019 15:35:04 GMT -->
<head>
<meta charset="utf-8">
<title>Ourland - Real Estate HTML Template | Property Modern View</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="property-modern-view">
        <div class="auto-container">
                ...
                <div class="row">
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <figure class="image"><a href="images/resource/property-9.jpg" class="lightbox-image" data-fancybox="properties"><img src="images/resource/property-9.jpg" alt=""></a></figure>
                    ...
                    <div class="content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="price"><i class="la la-money"></i> $ 356,564</div>
            ...
            <!-- Property Block -->
            <div class="property-block-four style-two">
                <div class="row">
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <figure class="image"><a href="images/resource/property-10.jpg" class="lightbox-image" data-fancybox="properties"><img src="images/resource/property-10.jpg" alt=""></a></figure>
                            <ul class="property-info clearfix">
                                <li><i class="flaticon-dimension"></i> 356 Sq-Ft</li>
                                <li><i class="flaticon-bed"></i> 4 Bedrooms</li>
                                <li><i class="flaticon-car"></i> 2 Garage</li>
            ...
            <div class="property-block-four">
                <div class="row">
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <figure class="image"><a href="images/resource/property-11.jpg" class="lightbox-image" data-fancybox="properties"><img src="images/resource/property-11.jpg" alt=""></a></figure>
                            <ul class="property-info clearfix">
                                <li><i class="flaticon-dimension"></i> 356 Sq-Ft</li>
                                <li><i class="flaticon-bed"></i> 4 Bedrooms</li>
                                <li><i class="flaticon-car"></i> 2 Garage</li>
            ...
            <div class="property-block-four style-two">
                <div class="row">
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <figure class="image"><a href="images/resource/property-12.jpg" class="lightbox-image" data-fancybox="properties"><img src="images/resource/property-12.jpg" alt=""></a></figure>
                            <ul class="property-info clearfix">
                                <li><i class="flaticon-dimension"></i> 356 Sq-Ft</li>
                                <li><i class="flaticon-bed"></i> 4 Bedrooms</li>
                                <li><i class="flaticon-car"></i> 2 Garage</li>
...
<!-- Tiger Cage/property-modern-view.html by g4bbar, Thu, 24 Jan 2019 15:35:11 GMT -->
</html>