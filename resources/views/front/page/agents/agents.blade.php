...
<!-- Tiger Cage/agents.html by g4bbar, Thu, 24 Jan 2019 15:34:49 GMT -->
<head>
<meta charset="utf-8">
<title>Ourland - Real Estate HTML Template | Agents</title>
<!-- Stylesheets -->
            ...
            @forelse($agents as $agent)
                <div class="agent-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="info-box">
                            <h4 class="name"><a href="{{route('agent.detail',$agent->id)}}">Magda Anoma</a></h4>
...
<!-- Tiger Cage/agents.html by g4bbar, Thu, 24 Jan 2019 15:34:55 GMT -->
</html>