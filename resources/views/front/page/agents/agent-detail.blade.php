                ...
                <div class="content-column col-lg-8 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="about-agent">
                           <a href="{{route('agent.detail',$single_agent->id)}}"> <h3 class="name">{{$single_agent->name}}</h3>
            ...
            <div class="auto-container">
                ...
                <div class="agents-carousel owl-carousel owl-theme">
                    ...
                    <div class="agent-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="{{route('agent.detail',$agent->id)}}"><img src="{{asset($agent->image)}}" alt="" style="max-height: 300px;min-height: 300px"></a></figure>
                                <ul class="social-links">
        ...
        <div class="auto-container">
            ...
            <div class="agents-carousel owl-carousel owl-theme">
                ...
                <div class="agent-block">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="#"><img src="{{asset($agent->image)}}" alt="" style="max-height: 300px;min-height: 300px"></a></figure>
                            <ul class="social-links">
                                <li><a href="#"><i class="la la-facebook-f"></i></a></li>
                                <li><a href="#"><i class="la la-twitter"></i></a></li>
                                <li><a href="#"><i class="la la-google-plus"></i></a></li>
