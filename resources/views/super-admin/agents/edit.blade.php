                        ...
                        <div class="appointment-form">
                            ...
                            <form method="post" action="{{route('agent.update',$agent->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-lg-4 col-md-12 col-sm-12">
                                    <input type="text" name="name" id="name" placeholder="Name" value="{{$agent->name}}">
                                     @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} col-lg-4 col-md-12 col-sm-12">
                                    <input type="text" name="email" id="email" placeholder="Email" value="{{$agent->email}}">
                                     @if ($errors->has('email'))
                                    <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }} col-lg-4 col-md-12 col-sm-12">
                                    <input type="text" name="phone" id="phone" placeholder="Phone" value="{{$agent->phone}}">
                                     @if ($errors->has('phone'))
                                    <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('detail') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12">
                                    <textarea name="detail" placeholder="Detail" required>{{$agent->detail}}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }} col-lg-6 col-md-12 col-sm-12">
                                    <input type="text" name="address" id="address" placeholder="Address" value="{{$agent->address}}">
